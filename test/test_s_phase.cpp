...
class SPhaseTest : public ::testing::Test
{
  ...
  protected:
    ...
    void SetUp()
    {
        ...
        // HACK: Inhibit tests from printing to cout
...
TEST_F(SPhaseTest, WithoutTranscription)
{
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        chrm_0_times.open(
            "../test/expected_outputs/dummy01_times_without_transcription.txt");
...
TEST_F(SPhaseTest, WithTranscription)
{
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        std::ifstream chrm_0_times;
        chrm_0_times.open(
            "../test/expected_outputs/dummy01_times_with_transcription.txt");
...
TEST_F(SPhaseTest, ConstitutiveWithoutTranscription)
{
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        chrm_0_times.open(
            ...
            "dummy01_times_constitutive_without_transcription.txt");
...
TEST_F(SPhaseTest, ConstitutiveWithTranscription)
{
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        std::ifstream chrm_0_times;
        chrm_0_times.open("../test/expected_outputs/"
                          "dummy01_times_constitutive_with_transcription.txt");
...
TEST_F(SPhaseTest, DormantWithoutTranscription)
{
    std::vector<const char *> const_argv_mock = {"program_name",
                                                 "--gpu",
                                                 "false",
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        std::ifstream chrm_0_times;
        chrm_0_times.open("../test/expected_outputs/"
                          "dummy01_times_dormant_without_transcription.txt");
...
TEST_F(SPhaseTest, DormantWithTranscription)
{
    std::vector<const char *> const_argv_mock = {"program_name",
                                                 "--gpu",
                                                 "false",
    ...
    for (long long unsigned int i = 0; i < arg_values.cells; i++)
    {
        ...
        std::ifstream chrm_0_times;
        chrm_0_times.open("../test/expected_outputs/"
                          "dummy01_times_dormant_with_transcription.txt");
        ...
        EXPECT_EQ(fork_manager->metric_times_attached, 4);
        EXPECT_EQ(fork_manager->metric_times_detached_normal, 2);
        EXPECT_EQ(fork_manager->metric_times_detached_collision, 1);
        EXPECT_NEAR(s_phase->get_genome()->average_interorigin_distance(), 50.0,
                    0.001);
        EXPECT_EQ(s_phase->get_stats().collisions, 1);
        EXPECT_EQ(s_phase->get_stats().time, 135);
        EXPECT_EQ(n_fired_origins, 2);
